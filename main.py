...
code = template.render(header=code_header, notebook=False, **inputs)
notebook_code = template.render(header=notebook_header, notebook=True, **inputs)
notebook = to_notebook(notebook_code)
...
with col2:
    download_button(code, "generated-code.py", "🐍 Download (.py)")
with col3:
    download_button(notebook, "generated-notebook.ipynb", "📓 Download (.ipynb)")
